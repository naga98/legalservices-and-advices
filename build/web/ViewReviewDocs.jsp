            ...
            <div class="row" style="margin-left: -180px">
                <div class="col-md-12">
                    <%
                        ...
                        //out.println(userid);
                        DAO dao=new DAO();
                        ArrayList<ReviewDoc> tl=dao.getReviewDocsByAdmin(userid);
                        ...
                        for(ReviewDoc toaLawyerBean:tl)
                        {
                          ...
                          out.println("<td><a href='ResponseReviewDoc.jsp?tlid="+toaLawyerBean.getSlno()+"&laweremail="+toaLawyerBean.getToEmaild()+"&useremail="+toaLawyerBean.getFromEmailId()+"'>Response</a></td>");
