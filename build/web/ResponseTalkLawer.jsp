                ...
                <div class="col-md-12">
                    <%
                        ...
                        //out.println(userid);
                         ...
                         DAO dao=new DAO();
                        ResultSet rs=dao.viewAskedTalks(userid);
                        out.println("<table class=table table-dark table-hover border=1px; style='margin-top:100px;width=1000px;'>");
                        out.println("<thead><th>slno</th><th>Qid</th><th>Lawyer Email</th><th>Law</th><th>Title</th><th>Question</th></thead>");
                        int i=1;
                        while(rs.next())
                        {
                           out.println("<tr>");
                           ...
                           out.println("<td>"+rs.getString("ToEmailid")+"</td>");
...
//                         out.println("<td>"+rs.getString("pincode")+"</td>");
                           out.println("<td><a href='ViewResponseOfTalks.jsp?qid="+qid+"'>View Responses</a></td>");
                           out.println("</tr>");
                           i++;
                        }
                    %>  
...
<!--//                        DAO dao=new DAO();
//                        ResultSet rs=dao.viewResponseTalkLawer(userid);
