...
<div class="row justify-content-center align-items-center">
            <h1><strong>Talk To Lawyers</strong></h1>
            </div>
<div class="row justify-content-center align-items-center">
<%
 ...
 <div class="container" style="min-height: 500px;margin-left: -100px;">
                <form action="TalktoaLawyerServlet">
                     <div class="form-group">
                         <input type="text" class="form-control" id="EmailId" value="<%=law%>" placeholder="ToEmailid" name="ToEmailid" style="width: 300px">
                    </div>
