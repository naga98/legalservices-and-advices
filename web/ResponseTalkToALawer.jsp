            ...
            <div class="row">
                ...
                <%
                    ...
                    if(method.equalsIgnoreCase("post"))
                    {
                        ...
                        DAO dao=new DAO();
                        if(dao.responsetalklawer(tlid,laweremail,useremail,lawerresp)==true)
                        {
                            response.sendRedirect("ViewTalkToALawer.jsp?msg=response sended");
                        }
                        else
                        {
                           response.sendRedirect("ViewTalkToALawer.jsp?msg=response not sended"); 
                        }
                    }
                %>
            </div>
